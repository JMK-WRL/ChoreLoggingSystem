...
Namespace Forms
    Public Class ManagerLoginForm
        ...
        Private _authenticatedManager As Staff

        Public ReadOnly Property AuthenticatedManager As Staff
            Get
        ...
        Private Sub buttonLogin_Click(sender As Object, e As EventArgs) Handles buttonLogin.Click
            Try
                ...
                ' For now, use simple authentication (replace with actual database authentication later)
                _authenticatedManager = AuthenticateUser(textBoxUserID.Text.Trim().ToUpper(), textBoxPIN.Text.Trim())

                If _authenticatedManager IsNot Nothing Then
        ...
        Private Function AuthenticateUser(userID As String, pin As String) As Staff
        ...
        Private Sub InitializeComponent()
            ...
            panelLogin.Size = New Size(360, 280)
            ...
            labelLoginTitle.Location = New Point(120, 50)
            labelLoginTitle.Size = New Size(120, 19)
            labelLoginTitle.Text = "MANAGER LOGIN"
            ...
            labelInstructions.Location = New Point(100, 75)
            labelInstructions.Size = New Size(160, 13)
            labelInstructions.Text = "Authorized personnel only"
            ...
            buttonLogin.Location = New Point(100, 210)
            ...
            buttonCancel.Location = New Point(190, 210)
            ...
            Text = "Manager Login - Excellence Care Solutions"
